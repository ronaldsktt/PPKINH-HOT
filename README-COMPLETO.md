...
const PRODUTOS = {
  'bia': {
    nome: 'Bia Miranda',
    bot_url: 'https://t.me/BiaaMirandaa_bot?start=adsbiamiranda',
    grupo_vip: 'https://t.me/+8-iHiUeNyy9jY2Zh',
    foto: 'https://i.postimg.cc/RhGMvg71/image.jpg',
    cor_primaria: '#ff4da6',
...
```javascript
fbq('init', '2213928055755103'); // ← TROCAR PELO SEU PIXEL ID
```
